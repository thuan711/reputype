...
foreach ($titleElements as $key => $element) {
    ...
    if ($element->parentNode->getAttribute('class') != 'article-content') {
        $outerClass = $element->parentNode->getAttribute('class');
        // Tiếp tục xử lý các lớp (classes) bên ngoài ở đây
        // ...
    } else {
        $innerClass = $element->getAttribute('class');
        ...
        // Tiếp tục xử lý thông tin trong 'article-content' ở đây
        // ...
    }
